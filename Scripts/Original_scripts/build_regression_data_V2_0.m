...
% Test for a subset of subjects so set all remaining ones to 0
%grotKEEP(21:end) = 0;
...
% Now we remove variables that have lots of NaN values
keep = true(1,p);
for BV = 1:p
    Y=vars(:,BV);
