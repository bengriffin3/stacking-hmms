...
rep_selection_vec = [2 6 14 25 44];
Entropy = Entropy_subject(:,rep_selection_vec);
...
figure
sgtitle('Correlation values between prediction error and metafeature  (Gaussianized) - histograms') 
...
% for rep = 1:45
%     figure()
%    Entropy_rep = Entropy_subject(:,rep);
