...
% Load data
clear; clc;
DirFC = 'C:\Users\au699373\OneDrive - Aarhus Universitet\Dokumenter\MATLAB\HMMMAR_BG\HMMMAR Results\FEB_2022\Varying_states\';
%DirFC = ['C:\Users\au699373\OneDrive - Aarhus Universitet\Dokumenter\MATLAB\HMMMAR_BG\HMMMAR Results\FEB_2022\Same_states\'];
load([DirFC 'HMMs_r7_GROUP.mat'])
K = hmm.K;
...
x = 1:4800; % we plot the following graphs for the first 'x' time points
