...
%DirFC = 'C:\Users\au699373\OneDrive - Aarhus Universitet\Dokumenter\MATLAB\HMMMAR_BG\HMMMAR Results\FEB_2022\Same_states\';
%DirFC = 'C:\Users\au699373\OneDrive - Aarhus Universitet\Dokumenter\MATLAB\HMMMAR_BG\HMMMAR Results\FEB_2022\All_vars\';
...
for i = 1:n_iterations
    ...
    average_diff_vec = zeros(n_iterations,1);
    for j = 1:length(feature_groupings)-1
...
load([DirResults 'FC_HMM_zeromean_1_covtype_full/HMM_predictions.mat']); explained_variance_FC_HMM = explained_variance;
...
load([DirResults 'VAR_HMM_zeromean_1_covtype_diag/HMM_predictions_MANUFACTURED.mat']); explained_variance_store{2} = explained_variance; % (iii) Var-HMM
