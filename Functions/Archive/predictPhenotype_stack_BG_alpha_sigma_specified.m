function [predictedY,predictedY_ST,W,W_max,QpredictedY_store,QYin_store,folds,sigma_store,alph_store]...
    = predictPhenotype_stack_BG_alpha_sigma_specified(Yin,Din,options,varargin)
