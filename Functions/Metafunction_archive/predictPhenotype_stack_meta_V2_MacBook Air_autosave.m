function [predictedY_ST, predictedY_stack,predictedY_stack_static,predictedY_FWLS,predictedY_FWLS_norm,predictedY_ridge,W_stack,W_stack_static,W_FWLS,W_FWLS_norm,W_ridge,sigma_store,alpha_store]...
    = predictPhenotype_stack_meta_V2(Yin,Din_HMM,Din_static,metafeatures,options,varargin)
%%%%%%% Metafeature code %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
sigma_store = zeros(M,10);
alpha_store = zeros(M,10);
