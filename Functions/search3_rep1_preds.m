function search3_rep1_preds(r,j)
...
DirOut = 'C:\Users\au699373\OneDrive - Aarhus Universitet\Dokumenter\MATLAB\HMMMAR_BG\HMMMAR Results\MAR_2022\Investigating_variability\Repetition7_non_TDE\'; % Test folder
...
load([DirOut 'KLdistances_ICA' num2str(ICAdim) '_all.mat'],'DistMat')
...
parameters_prediction.CVscheme = [10 10];%[0 10];
